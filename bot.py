...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video(kk.id,img, "**Hello {}!\nWelcome To {}\n\n__Powerd By : @DK_ANIMES __**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
...
async def chk(_, cb : CallbackQuery):
    try:
        await app.get_chat_member(cb.from_user.id)
        if cb.message.chat.type == enums.ChatType.PRIVATE:
            ...
            await cb.message.edit("**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @DK_ANIMES __**".format(cb.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard, disable_web_page_preview=True)
